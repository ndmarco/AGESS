...
## Prior on β
function log_prior(β::AbstractVector{Y}, μ::AbstractVector{Y}, Σ_chol::LowerTriangular{Y, Matrix{Y}}) where {Y <:AbstractFloat}
    log_p = -0.5 * dot(β, β)
    return log_p
end
...
ESS_2 = [ESS_per_second_ESS[1,:]';ESS_per_second_AGESS[1,:]'; ESS_per_second_ARW[1,:]']
scatter1 = scatter(percent_zero[1,:], ESS_2', label=["ESS" "AGESS" "ARW"], title = "Effective Sample Size per Second (P = 2)", )
ylabel!("Effective Sample Size per Second")
xlabel!("Proportion of μ that are zero")
box1 = boxplot(["ESS" "AGESS" "ARW"], ESS_2', title = "Effective Sample Size (P = 2)")
ylabel!("Effective Sample Size per Second")

ESS_2 = [ESS_per_second_ESS[2,:]';ESS_per_second_AGESS[2,:]'; ESS_per_second_ARW[2,:]']
scatter2 = scatter(percent_zero[2,:], ESS_2', label=["ESS" "AGESS" "ARW"], title = "Effective Sample Size per Second (P = 10)", )
ylabel!("Effective Sample Size per Second")
xlabel!("Proportion of μ that are zero")
box2 = boxplot(["ESS" "AGESS" "ARW"], ESS_2', title = "Effective Sample Size per Second (P = 10)")
ylabel!("Effective Sample Size per Second")



ESS_2 = [ESS_per_second_ESS[3,:]';ESS_per_second_AGESS[3,:]'; ESS_per_second_ARW[3,:]']
scatter3 = scatter(percent_zero[3,:], ESS_2', label=["ESS" "AGESS" "ARW"], title = "Effective Sample Size per Second (P = 50)", )
ylabel!("Effective Sample Size per Second")
xlabel!("Proportion of μ that are zero")
box3 = boxplot(["ESS" "AGESS" "ARW"], ESS_2', title = "Effective Sample Size per Second (P = 50)")
ylabel!("Effective Sample Size per Second")

plot(box1,scatter1, box2, scatter2, box3, scatter3, layout = (3,2))
plot!(size = (1000,1000))